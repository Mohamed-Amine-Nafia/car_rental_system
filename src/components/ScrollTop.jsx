...
function ScrollTop() {
  ...
  return (
    ...
    >
      ...
      >
        <img
          className=" w-16 md:w-18 animate-bounce"
      ...
      <div
        className={` ${isScroll ? "scale-100" : "scale-0"} bg-accent text-secondary  rounded-full flex flex-col items-center justify-center   md:w-14 md:h-14 w-12 h-12  hover:bg-secondary hover:text-ternary duration-200 ease-linear `}
      >
