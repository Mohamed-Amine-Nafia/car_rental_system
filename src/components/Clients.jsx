    ...
    <div className="relative h-screen w-full bg-primary  px-6 py-3">
      ...
      <div className="mt-8">
        <div className="text-xs flex items-center ">
          <span className="inline-flex items-center gap-1.5 bg-secondary text-ternary py-2 px-4 w-1/4 rounded-tl-full rounded-bl-full">
            <User size={16} />
            NOM COMPLET
          </span>
          ...
          <span className="inline-flex items-center gap-1.5 bg-secondary text-ternary py-2 px-4 w-1/4 rounded-tr-full rounded-br-full">
            <IdCard size={16} />
            N° PERMIS
          </span>
        </div>
